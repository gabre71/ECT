...
describe TimeSheetsController do
  ...
  describe "GET index" do
    it "assigns all time_sheets as @time_sheets" do
      ...
      assigns(:time_sheets).should eq([time_sheet])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested time_sheet as @time_sheet" do
      ...
      assigns(:time_sheet).should eq(time_sheet)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new time_sheet as @time_sheet" do
      ...
      assigns(:time_sheet).should be_a_new(TimeSheet)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created time_sheet as @time_sheet" do
        post :create, {:time_sheet => valid_attributes}, valid_session
        assigns(:time_sheet).should be_a(TimeSheet)
        assigns(:time_sheet).should be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved time_sheet as @time_sheet" do
        ...
        post :create, {:time_sheet => { "user" => "invalid value" }}, valid_session
        assigns(:time_sheet).should be_a_new(TimeSheet)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested time_sheet" do
        time_sheet = TimeSheet.create! valid_attributes
        # Assuming there are no other time_sheets in the database, this
        # specifies that the TimeSheet created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        TimeSheet.any_instance.should_receive(:update_attributes).with({ "user" => "" })
        put :update, {:id => time_sheet.to_param, :time_sheet => { "user" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the time_sheet as @time_sheet" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        TimeSheet.any_instance.stub(:save).and_return(false)
        put :update, {:id => time_sheet.to_param, :time_sheet => { "user" => "invalid value" }}, valid_session
        assigns(:time_sheet).should eq(time_sheet)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the time_sheets list" do
      time_sheet = TimeSheet.create! valid_attributes
      delete :destroy, {:id => time_sheet.to_param}, valid_session
      response.should redirect_to(time_sheets_url)
    end
  end
